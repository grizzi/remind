...
urlpatterns = [
    ...
    path("subscriptions/<int:subscription_id>/plans/", views.PlanListCreate.as_view()),
    path("subscriptions/<int:subscription_id>/plans/<int:pk>", views.PlanDetails.as_view()),
